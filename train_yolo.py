# -*- coding: utf-8 -*-
"""
Created on Wed Sep 23 18:50:04 2020
...
def _main():
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='YOLO Files/tiny_yolo_weights.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='YOLO Files/yolo_weights.h5') # make sure you know what you freeze
    ...
    if True:
        ...
        model.save_weights(log_dir + n + '_trained_weights_stage_50.h5')
    ...
    if True:
        ...
        model.save_weights(log_dir + n + '_trained_weights_stage_100.h5')
    ...
    if True:
        ...
        model.fit_generator(data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes),
            ...
            initial_epoch=100,
            callbacks=[logging, checkpoint, reduce_lr, early_stopping])
        model.save_weights(log_dir + n + '_trained_weights_final.h5')
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
            weights_path='YOLO files/yolo_weights.h5'):
